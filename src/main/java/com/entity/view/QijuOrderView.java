...
public class QijuOrderView extends QijuOrderEntity implements Serializable {
	...
	*/
	...
	private String qijuOrderValue;
	/**
	* 支付类型的值
	*/
	@ColumnInfo(comment="支付类型的字典表值",type="varchar(200)")
	private String qijuOrderPaymentValue;
	...
	public QijuOrderView() {

	}

	public QijuOrderView(QijuOrderEntity qijuOrderEntity) {
		try {
			BeanUtils.copyProperties(this, qijuOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getQijuOrderValue() {
		return qijuOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setQijuOrderValue(String qijuOrderValue) {
		this.qijuOrderValue = qijuOrderValue;
	}
	//当前表的
	/**
	* 获取： 支付类型的值
	*/
	public String getQijuOrderPaymentValue() {
		return qijuOrderPaymentValue;
	}
	/**
	* 设置： 支付类型的值
	*/
	public void setQijuOrderPaymentValue(String qijuOrderPaymentValue) {
		this.qijuOrderPaymentValue = qijuOrderPaymentValue;
	}
	...
	public String toString() {
		return "QijuOrderView{" +
			", qijuOrderValue=" + qijuOrderValue +
			", qijuOrderPaymentValue=" + qijuOrderPaymentValue +
			", qijuName=" + qijuName +
