...
public class SaidaoLiuyanView extends SaidaoLiuyanEntity implements Serializable {
	...
	public SaidaoLiuyanView() {

	}

	public SaidaoLiuyanView(SaidaoLiuyanEntity saidaoLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, saidaoLiuyanEntity);
