...
public class QijuCommentbackView extends QijuCommentbackEntity implements Serializable {
	...
	public QijuCommentbackView() {

	}

	public QijuCommentbackView(QijuCommentbackEntity qijuCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, qijuCommentbackEntity);
