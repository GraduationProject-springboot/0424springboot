...
import com.entity.SaidaoCollectionEntity;
...
*/
@TableName("saidao_collection")
public class SaidaoCollectionView extends SaidaoCollectionEntity implements Serializable {
	...
	*/
	...
	private String saidaoCollectionValue;
	...
	public SaidaoCollectionView() {

	}

	public SaidaoCollectionView(SaidaoCollectionEntity saidaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, saidaoCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getSaidaoCollectionValue() {
		return saidaoCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setSaidaoCollectionValue(String saidaoCollectionValue) {
		this.saidaoCollectionValue = saidaoCollectionValue;
	}
	...
	public String toString() {
		return "SaidaoCollectionView{" +
			", saidaoCollectionValue=" + saidaoCollectionValue +
